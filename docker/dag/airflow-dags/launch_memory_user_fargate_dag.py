...
## ========================================= 👇 TO MODIFY WHEN COPY 👇 =======================##
DAG_SCHEDULE                    = None
DAG_NAME                        = 'launch_memory_user_fargate_dag'
DESCRIPTION                     = "Launch script with medium memory usage on fargate"
## ========================================= 👆 TO MODIFY WHEN COPY 👆 =======================##
...
# tasks
task = KubernetesPodOperator(namespace='fargate',  # Specifying a DAG to run in fargate is done through changing to the 'fargate' namespace, because this is the namespace Fargate operates in
                                image="<DAG ECR URL>",  # You need to specify the Dag ECR Repository URL here
                                ...
                                startup_timeout_seconds=600,  # Fargate needs increased startup time
                                resources = {'request_cpu': '3.0'},
                                get_logs=True,
                                default_args=default_args
                                )
